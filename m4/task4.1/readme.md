# Module 4 Networking Fundamentals. TASK 4.1
1. Зібрати наступний проект (рис 1), який містить в собі: 4 ПК типу PC- PT, Концентратор (Hub-PT). 
...
![Image](https://github.com/Deodatuss/DevOps_online_Kyiv_2021Q2/blob/main/m4/task4.1/screenshots/msedge_t7xYQ7t6q3.png)
3. Кожному ПК привласнити унікальну IP адресу. Для її призначення необхідно зайти в меню конфігурації ПК шляхом одноразового клацання по
ньому лівою кнопкою миші і вибору вкладки Config / Interface. В полі ip address необхідно ввести відповідну адресу, а в полі Subnet Mask - відповідно цьому адресу маску.
...
мережі.
![Image](https://github.com/Deodatuss/DevOps_online_Kyiv_2021Q2/blob/main/m4/task4.1/screenshots/PacketTracer_TTKbbUnpEZ.png)
...
![Image](https://github.com/Deodatuss/DevOps_online_Kyiv_2021Q2/blob/main/m4/task4.1/screenshots/PacketTracer_9w7SHCoBMY.png)
...
Результати зберегти як скриншот.
![Image](https://github.com/Deodatuss/DevOps_online_Kyiv_2021Q2/blob/main/m4/task4.1/screenshots/PacketTracer_WpYRLcMNKj.png)
8. Видалити IP адреса з кожною локальною машини PC0 - PC3.
Повторити пункти 5 - 10. Проаналізувати відмінності в роботі мережі.
![Image](https://github.com/Deodatuss/DevOps_online_Kyiv_2021Q2/blob/main/m4/task4.1/screenshots/PacketTracer_X56AB00t3T.png)
...
![Image](https://github.com/Deodatuss/DevOps_online_Kyiv_2021Q2/blob/main/m4/task4.1/screenshots/PacketTracer_W07c1LDPTa.png)
...
13. Для даної топології повторити пункти 3-9. Проаналізувати
відмінності в роботі мережі Топології 1 і Топології 3.
![Image](https://github.com/Deodatuss/DevOps_online_Kyiv_2021Q2/blob/main/m4/task4.1/screenshots/PacketTracer_vw9a7OrtJl.png)
...
Cross-over).
15. За необхідністю додати додаткові порти на комутатори. Для цього
необхідно у вкладці Physical / MODULES кожного з них перетягнути
доступний порт Ethernet в порожнє гніздо, попередньо вимкнувши комутатор
за допомогою кнопки вимкнення.
17. Перевірити працездатність мережі.
![Image](https://github.com/Deodatuss/DevOps_online_Kyiv_2021Q2/blob/main/m4/task4.1/screenshots/PacketTracer_s6lmXXCK2h.png)
...
![Image](https://github.com/Deodatuss/DevOps_online_Kyiv_2021Q2/blob/main/m4/task4.1/screenshots/PacketTracer_NvoUv6VQ2w.png)
23. Проаналізувати відмінності в роботі мережі Топології 4 і Топології
5. Оцінити можливості, які дає використання маршрутизатора.
